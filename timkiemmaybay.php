...
<body>
	<h1 style="color: yellow">Flight Ticket Booking</h1>
			...
			<div id="horizontalTab">
				...
				<div class="resp-tabs-container">
					<div class="tab-1 resp-tab-content roundtrip">
						<form action="thucthiRoundTrip.php" method="post">
							<div class="from">
								<h3>Nơi xuất phát:</h3>
								<input type="text" name="diemdi" class="city1" placeholder="nơi khởi hành" required="">
							</div>
							<div class="to">	
								<h3>Nơi đi đến:</h3>
								<input type="text" name="diemden" class="city2" placeholder="nơi đi đến" required="">
							</div>
							<div class="clear"></div>
							<div class="date">
								<div class="depart">
									<h3>Ngày đi:</h3>
									<input  id="datepicker" name="ngaydi" type="text" value="yyyy/mm/dd" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'yyyy/mm/dd';}" required="">
								...
								<div class="return">
									<h3>ngày về:</h3>
									<input  id="datepicker1" name="ngayve" type="text" value="yyyy/mm/dd" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'yyyy/mm/dd';}" required="">
									<span class="checkbox1">
										<label class="checkbox"><input type="checkbox" name="" checked=""><i> </i>Flexible with date</label>
									</span>
								</div>
					...
					<div class="tab-1 resp-tab-content oneway">
						<form action="#" method="post">
							<div class="from">
								<h3>Nơi xuất phát:</h3>
								<input type="text" name="diemdi" class="city1" placeholder="Nơi xuất phát" required="">
							</div>
							<div class="to">
								<h3>To</h3>
								<input type="text" name="diemden" class="city2" placeholder="Nơi đi đến" required="">
							...
							<div class="date">
								<div class="depart">
									<h3>ngày đi</h3>
									<input class="date" id="datepicker2" name="ngaydi" type="text" value="mm/dd/yyyy" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'mm/dd/yyyy';}" required="">
									<span class="checkbox1">
										<label class="checkbox"><input type="checkbox" name="" checked=""><i> </i>Flexible with date</label>
									</span>
								</div>
							...
							<div class="class">
								...
								<select id="w3_country1" onchange="change_country(this.value)" class="frm-field required">
									<option value="null">Thương gia</option>  
	...
	<div class="footer-w3l">
		<p class="agileinfo"> &copy; <a href="http://w3layouts.com"></a></p>
	</div>
